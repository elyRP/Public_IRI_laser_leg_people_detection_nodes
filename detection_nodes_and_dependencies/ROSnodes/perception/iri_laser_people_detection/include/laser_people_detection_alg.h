...
#define _laser_people_detection_alg_h_

#include <iri_laser_people_detection/LaserPeopleDetectionConfig.h>
#include "mutex.h"
 ...
 *
 */
class LaserPeopleDetectionAlgorithm
{
  protected:
   /**
    * \brief define config type
    *
    * Define a Config type with the LaserPeopleDetectionConfig. All driver implementations
  ...
  public:
    ...
    * will then use the same variable type Config.
    */
    typedef iri_laser_people_detection::LaserPeopleDetectionConfig Config;
    ...
    */
    LaserPeopleDetectionAlgorithm(void);
    ...
    */
    ...
    // here define all laser_people_detection_alg interface methods to retrieve and set
    // the driver parameters
    void iteration(const sensor_msgs::LaserScan scan, iri_perception_msgs::detectionArray & people);
