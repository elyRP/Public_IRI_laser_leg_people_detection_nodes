...
CLaserPeopleDetection::CLaserPeopleDetection()
{
  ...
  boostFilePath  = "/usr/local/include/iri/laser_people_detection/boostData/";
  boostFilePath2 = "/usr/local/include/iri/laser_people_detection/boostData/";
...
{
  if(debug)
    std::cout << "CLaserPeopleDetection::locatePeople()" << std::endl;
...
void CLaserPeopleDetection::setPersonRadius(const double personRadius)
{
  ...
  if(this->person_radius!=personRadius)
  {
    ...
    std::cout << "CLaserPeopleDetection::setPersonRadius: person radius set to: "<< this->person_radius << std::endl;
  }
}
