...
CLogException::CLogException(const std::string& where, const std::string& error_msg,const std::string& filename):CException(where,exception_msg)
{
  this->error_msg+=error_msg;
  this->error_msg+=" - ";
  this->error_msg+=filename;
}
